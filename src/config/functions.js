...
// export function getFragments(arr, char){
...
//     let count = 0;
//     let ccount = 0;
//     for(let r = 0;r < 4;r++){//get 4 sets of 3
...
//       }
//     }
//     for(let s = 0;s < 4;s++){//get 4 sets of 2
...
//     if((fragArray[0].length === 4 && fragArray[1].length === 4 && fragArray[2].length === 6) || outerCount > 500){
